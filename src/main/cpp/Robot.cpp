...
void Robot::RobotInit() {
  ...
  limelight = new wom::vision::Limelight("Limelight");
  swerve = new wom::drivetrain::Swerve(robotmap.swerveConfig, wom::SwerveState::kIdle, limelight);

  behaviour::BehaviourScheduler::GetInstance()->Register(swerve);
...
void Robot::RobotPeriodic() {
  ...
  lastPeriodic = wom::now();
  loop.Poll();
  behaviour::BehaviourScheduler::GetInstance()->Tick();
